...
```
  ...
  <verify>
    <automated>test -f docs/HEDGE-POLICY.md && grep -q "Status:.*Locked" docs/HEDGE-POLICY.md && grep -q "fixed-ratio v1\|Fixed (v1)" docs/HEDGE-POLICY.md && grep -q "allocation_bps = 1000" docs/HEDGE-POLICY.md && grep -q "strike_otm_bps = 1500" docs/HEDGE-POLICY.md && grep -q "tenor_seconds = 1209600" docs/HEDGE-POLICY.md && grep -q "roll_trigger_seconds = 172800" docs/HEDGE-POLICY.md && grep -q '"fixed"' docs/HEDGE-POLICY.md && grep -q "10%" docs/HEDGE-POLICY.md && grep -q "\-15%" docs/HEDGE-POLICY.md && grep -q "14 days\|14-day" docs/HEDGE-POLICY.md && grep -q "Re-tuning policy" docs/HEDGE-POLICY.md && grep -q "Pitfall 2" docs/HEDGE-POLICY.md && grep -q "shared/strategy.toml" docs/HEDGE-POLICY.md && grep -q "Walk-forward\|walk-forward" docs/HEDGE-POLICY.md && grep -q "Permanent freeze" docs/HEDGE-POLICY.md</automated>
  </verify>
  <acceptance_criteria>
...
```
  ...
  <verify>
    <automated>test -f docs/MAINNET-FUNDING.md && grep -q "~\$80" docs/MAINNET-FUNDING.md && grep -q "Cetus" docs/MAINNET-FUNDING.md && grep -q "SUI_CONFIG_DIR=~/.sui/sui_config_mainnet" docs/MAINNET-FUNDING.md && grep -q "\$50 USDsui" docs/MAINNET-FUNDING.md && grep -q "\$15" docs/MAINNET-FUNDING.md && grep -q "\$150" docs/MAINNET-FUNDING.md && grep -q "DEPLOY-04" docs/MAINNET-FUNDING.md && grep -q "DEPLOY-09\|D-09" docs/MAINNET-FUNDING.md && grep -q "2026-06-12\|Day 36" docs/MAINNET-FUNDING.md && grep -q "Pitfall 14" docs/MAINNET-FUNDING.md && grep -q "predict_mainnet_shipped" docs/MAINNET-FUNDING.md && grep -q "config/mainnet.toml" docs/MAINNET-FUNDING.md && grep -q "preflight" docs/MAINNET-FUNDING.md && grep -q "AdminCap" docs/MAINNET-FUNDING.md</automated>
  </verify>
  <acceptance_criteria>
